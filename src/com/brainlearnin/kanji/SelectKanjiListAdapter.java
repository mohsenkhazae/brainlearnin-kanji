...
public class SelectKanjiListAdapter extends ArrayAdapter<Integer> implements OnClickListener, OnCreateContextMenuListener
{
	private ArrayList<Integer> kanjis;
	...
	public SelectKanjiListAdapter(Context context, int textViewResourceId, ArrayList<Integer> kanjis_, TreeSet<String> selectionSet_, boolean singleSelect_) 
	{		
	...
	public View getView(int position, View convertView, ViewGroup parent) {
		...
		int itemIndex = this.kanjis.get(position);
	...
	public void onClick(View v) 
	{
		...
		KanjiQuiz.GlyphStat glyph = (KanjiQuiz.GlyphStat) cBox.getTag();
		...
		lastChecked = cBox;
		lastSelectionKanji = glyph.index;
		
		if (cBox.isChecked()) {
			selectionSet.add(glyph.glyph);
		} else {
			if (selectionSet.contains(glyph.glyph)) {
				selectionSet.remove(glyph.glyph);
			}//if
		}//if
	}//onClick
